set -euo pipefail
cd '/opt/ey-hospital/releases/ey-hospital-20260114085915'
...
if [ ! -f '/opt/ey-hospital/shared/db.json' ] || [ '1' = '1' ]; then
  cp -f '/opt/ey-hospital/releases/ey-hospital-20260114085915/server/data/db.json' '/opt/ey-hospital/shared/db.json'
fi
...
ln -sfn '/opt/ey-hospital/releases/ey-hospital-20260114085915' '/opt/ey-hospital/current'
...
echo "Deployed release: /opt/ey-hospital/releases/ey-hospital-20260114085915"
if [ -f "$FULLCHAIN" ] && [ -f "$PRIVKEY" ]; then
